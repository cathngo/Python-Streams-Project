...
def message_remove_v1(u_id, message_id): 
    ...
    # if owner_channel == False and user_sent_channel == False:
    #     raise AccessError(description="Cannot delete message because you are not an owner or did not send the message in channel")
