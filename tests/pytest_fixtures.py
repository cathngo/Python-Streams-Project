...
########################################################################
@pytest.fixture
def user1_react_to_their_message_in_channel(clear, reg_user1, send_channel_message_user1):
    user1 = reg_user1
...
########################################################################
@pytest.fixture
def user1_react_to_their_message_in_dm(clear, reg_user1, send_dm_message_user1):
    user1 = reg_user1
